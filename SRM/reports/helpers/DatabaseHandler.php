...
*/
	...
	class DatabaseHandler
	{
		...
		public $extension = '';
               ...
               /* public function set_debug_mode($var){
                    if($var===1){
		...
		{       
			...
			else if(extension_loaded('pdo') && version_compare(PHP_VERSION, '5.1.0') >= 0 && ($this->extension === '' || $this->extension === 'pdo' || $this->extension === 'mysqli'))
			{
		...
		{	
			...
			{ 
				...
				if($paramsType !== '') $edited_params =  array_merge(array($paramsType), $params);
