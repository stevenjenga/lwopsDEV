...
$resultcon = query( "SELECT table_name,COLUMN_NAME ,DATA_TYPE FROM INFORMATION_SCHEMA.COLUMNS"
			." WHERE  TABLE_SCHEMA = '".$db."' and ( $cond )","Menu: Get Data Types"
        );
...
$data=array();
if($datasource == "sql") $resultcon = array();
...
<div class="menu" style="z-index: 1; text-align: center;">
    ...
    <div class="nav-holder">
            ...
            <input type="text" class="search-txtbox" name="txtordnary_search" value="<?php echo get_default_value('txtordnary_search'); ?>" id="txtordnary_search" />
             ...
             if(isset($security))
                  {
                    if($security == "enabled")
                    {
                       echo " <a href='logout.php' id='LogOut' class='advanced-link' style='margin-left: 30px; margin-right: 4px;'>    Sign out</a>";
                    }
