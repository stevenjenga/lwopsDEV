            ...
            <table border="0" style="width:600px; margin:auto;" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select id="search_field" name="search_field" class="search-txtbox" style="width: 120px;padding-right: 5px;">
                            <?php printOption(); ?>
                        </select>   
                    </td> 
                    <td  style="width:5px;"  >&nbsp;  
...
<script language="JavaScript" type="text/javascript">
    ...
    $(function() {
        ...
        $("#search_field").change(function() {
            ...
            var dataty = $("#search_field option:selected").attr("dat");
        ...
        $("#btnSearch").click(function() {
            if (dataInt.indexOf($("#search_field option:selected").attr("dat")) > -1)
            {
                var Return = true;
            ...
            else if (dataBool.indexOf($("#search_field option:selected").attr("dat")) > -1)
            {
//		
                $("#HdSearchval").val("bool");
//		}
            }
            else if (dataDate.indexOf($("#search_field option:selected").attr("dat")) > -1)
            {
