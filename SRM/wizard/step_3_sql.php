<?php
    ...
    $sql = make_valide($sql); // validate sql
?>
<!--
<html>
	<head>
...
<!-- end index tags -->
		<script type="text/javascript">
			...
			$(function() {
				// set header images
				$("#page-header").empty();
				$("#page-header").append('<div id="img-container"><img src="designLayer/images/sql.png" width="70" height="70"/></div>');
					...
					$.ajax({
						...
						success: function(data){
							...
							if(is_success !== -1){ //SELECT * FROM `orders` 
								...
								if(data === '') $("#error-container").append("<div class='alert alert-danger'> Invalid SQL statement </div>");
