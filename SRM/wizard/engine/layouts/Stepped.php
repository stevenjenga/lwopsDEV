            ...
            if (count($result) < 1 || empty($result)) {
                ...
                as $key => $val) {
                    ...
                    if (in_array($field_, $group_by))
                        ...
                        echo"<td  align='center' class='ColumnHeader'><b>$labels[$val]</b> </td>";
                    }
                }
                    ...
                    if (!empty($group_by)) {
                        ...
                        for ($i = $index; $i < $levels; $i++) {
                            ...
                            if ($i == 0 && $index == 0) {
                                ...
                                echo "<tr class='mainpage' ><td align='center' class='TableCell' >" . $row[$group_by[0]] . "</td><td colspan='" . ($columns - 1) . "'></td> </tr>";
                            } else {
