...
<script>
	...
	$(function(){
		...
		$("#page-header").empty();
		$("#page-header").append('<div id="img-container"><img src="designLayer/images/groupby.png" width="70" height="70"/></div>');
		...
		$("#sorts-nav").click(function(){
			...
			$("#page-header").empty();
			$("#page-header").append('<div id="img-container"><img src="designLayer/images/sort.png" width="70" height="70"/></div>');
