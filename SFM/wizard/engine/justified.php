                        ...
                        if (!$insert_only && !$in_insert) {
                            ...
                            <div style="position: relative;overflow-x: hidden;display: inline-block;width: 30%;margin: 0px 0px 0px 0px;">
                                <div class="left-inner-addon">
                                    ...
                                    <input class="form-control" id="search_keyword" name="search_keyword" value="<?php
                        ...
                        <tr>
                            <td colspan="6">
                                <div class="pager" <?php if ($insert_only) echo 'style="display:none;"'; ?> >
                                    ...
                                    <input id="record" type="text" class="pager-records" name="number" value="<?php if ($_REQUEST['index'] == '-1')
                                           echo '*';
                                       else
                                           echo $index + 1;
                                       ?>" />
