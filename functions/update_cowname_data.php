<?php
/*
Description: update_emp_data.php is used to update employee data 
...
if($mode=="inserted")
{	
	$action = add_dairyproduction();
}
elseif($mode=="updated")
{
$action = update_dairyproduction();
}else
{
	$action = delete_dairyproduction();
}
