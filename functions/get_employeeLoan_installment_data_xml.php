...
function XXX() {
    ...
    $sql = "SELECT CONCAT(employee.firstName, ' ', employee.lastName) AS empName, employeeloanpmt.oid AS loanPmtOid, employeeOid, "
        . "MAX(deductionAmt) AS installmentAmt , MAX(`balanceAmount`) AS loanBalanceAmt "
