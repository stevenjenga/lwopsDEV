...
/**
 * Base class that represents a row from the 'fishpandl' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Fishpandl implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\FishpandlTableMap';
    ...
    /**
     * The value for the salesincome field.
     *
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Fishpandl object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Fishpandl</code> instance.  If
     * <code>obj</code> is an instance of <code>Fishpandl</code>, delegates to
     * <code>equals(Fishpandl)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Fishpandl The current object, for fluid interface
     */
    ...
    /**
     * Get the [salesincome] column value.
     *
     * @return double
     */
    ...
    /**
     * Get the [otherincome] column value.
     *
     * @return double
     */
     ...
     * @return $this|\lwops\lwops\Fishpandl The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[FishpandlTableMap::COL_OID] = true;
        }
    ...
    public function setLineofbusinessoid($v)
    {
        ...
        if ($this->lineofbusinessoid !== $v) {
            ...
            $this->modifiedColumns[FishpandlTableMap::COL_LINEOFBUSINESSOID] = true;
        }
    ...
    public function setOpsmonthlycalendaroid($v)
    {
        ...
        if ($this->opsmonthlycalendaroid !== $v) {
            ...
            $this->modifiedColumns[FishpandlTableMap::COL_OPSMONTHLYCALENDAROID] = true;
        }
    ...
    /**
     * Set the value of [salesincome] column.
     *
     * @param double $v new value
     * @return $this|\lwops\lwops\Fishpandl The current object (for fluent API support)
     */
    public function setSalesincome($v)
    {
        if ($v !== null) {
            $v = (double) $v;
        }

        if ($this->salesincome !== $v) {
            $this->salesincome = $v;
            $this->modifiedColumns[FishpandlTableMap::COL_SALESINCOME] = true;
        }
    ...
    /**
     * Set the value of [otherincome] column.
     *
     * @param double $v new value
     * @return $this|\lwops\lwops\Fishpandl The current object (for fluent API support)
     */
    public function setOtherincome($v)
    {
        if ($v !== null) {
            $v = (double) $v;
        }

        if ($this->otherincome !== $v) {
            $this->otherincome = $v;
            $this->modifiedColumns[FishpandlTableMap::COL_OTHERINCOME] = true;
        }
    ...
    public function setPurchases($v)
    {
        ...
        if ($this->purchases !== $v) {
            $this->purchases = $v;
            $this->modifiedColumns[FishpandlTableMap::COL_PURCHASES] = true;
        }
    ...
    public function setOtherpurchases($v)
    {
        ...
        if ($this->otherpurchases !== $v) {
            ...
            $this->modifiedColumns[FishpandlTableMap::COL_OTHERPURCHASES] = true;
        }
    ...
    public function setLabourparttimeexpense($v)
    {
        ...
        if ($this->labourparttimeexpense !== $v) {
            ...
            $this->modifiedColumns[FishpandlTableMap::COL_LABOURPARTTIMEEXPENSE] = true;
        }
    ...
    public function setGeneralexpenses($v)
    {
        ...
        if ($this->generalexpenses !== $v) {
            ...
            $this->modifiedColumns[FishpandlTableMap::COL_GENERALEXPENSES] = true;
        }
    ...
    public function setElecexpenses($v)
    {
        ...
        if ($this->elecexpenses !== $v) {
            $this->elecexpenses = $v;
            $this->modifiedColumns[FishpandlTableMap::COL_ELECEXPENSES] = true;
        }
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[FishpandlTableMap::COL_CREATETMSTP] = true;
            }
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[FishpandlTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FishpandlTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FishpandlTableMap::translateFieldName('Lineofbusinessoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lineofbusinessoid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FishpandlTableMap::translateFieldName('Opsmonthlycalendaroid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->opsmonthlycalendaroid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FishpandlTableMap::translateFieldName('Salesincome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salesincome = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FishpandlTableMap::translateFieldName('Otherincome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->otherincome = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FishpandlTableMap::translateFieldName('Purchases', TableMap::TYPE_PHPNAME, $indexType)];
            $this->purchases = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FishpandlTableMap::translateFieldName('Otherpurchases', TableMap::TYPE_PHPNAME, $indexType)];
            $this->otherpurchases = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : FishpandlTableMap::translateFieldName('Labourparttimeexpense', TableMap::TYPE_PHPNAME, $indexType)];
            $this->labourparttimeexpense = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : FishpandlTableMap::translateFieldName('Generalexpenses', TableMap::TYPE_PHPNAME, $indexType)];
            $this->generalexpenses = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : FishpandlTableMap::translateFieldName('Elecexpenses', TableMap::TYPE_PHPNAME, $indexType)];
            $this->elecexpenses = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : FishpandlTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : FishpandlTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 12; // 12 = FishpandlTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Fishpandl'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFishpandlQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Fishpandl::setDeleted()
     * @see Fishpandl::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFishpandlQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FishpandlTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FishpandlTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_LINEOFBUSINESSOID)) {
            $modifiedColumns[':p' . $index++]  = 'lineOfBusinessOid';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_OPSMONTHLYCALENDAROID)) {
            $modifiedColumns[':p' . $index++]  = 'opsMonthlyCalendarOid';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_SALESINCOME)) {
            $modifiedColumns[':p' . $index++]  = 'salesIncome';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_OTHERINCOME)) {
            $modifiedColumns[':p' . $index++]  = 'otherIncome';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_PURCHASES)) {
            $modifiedColumns[':p' . $index++]  = 'purchases';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_OTHERPURCHASES)) {
            $modifiedColumns[':p' . $index++]  = 'otherPurchases';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_LABOURPARTTIMEEXPENSE)) {
            $modifiedColumns[':p' . $index++]  = 'labourParttimeExpense';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_GENERALEXPENSES)) {
            $modifiedColumns[':p' . $index++]  = 'generalExpenses';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_ELECEXPENSES)) {
            $modifiedColumns[':p' . $index++]  = 'elecExpenses';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO fishpandl (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'opsMonthlyCalendarOid':
                        ...
                        break;
                    case 'salesIncome':
                        $stmt->bindValue($identifier, $this->salesincome, PDO::PARAM_STR);
                        break;
                    case 'otherIncome':
                        $stmt->bindValue($identifier, $this->otherincome, PDO::PARAM_STR);
                        break;
                    case 'purchases':
    ...
    {
        $pos = FishpandlTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getSalesincome();
                break;
            case 4:
                return $this->getOtherincome();
                break;
            case 5:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Fishpandl'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Fishpandl'][$this->hashCode()] = true;
        $keys = FishpandlTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
            $keys[1] => $this->getLineofbusinessoid(),
            $keys[2] => $this->getOpsmonthlycalendaroid(),
            $keys[3] => $this->getSalesincome(),
            $keys[4] => $this->getOtherincome(),
            $keys[5] => $this->getPurchases(),
            $keys[6] => $this->getOtherpurchases(),
            $keys[7] => $this->getLabourparttimeexpense(),
            $keys[8] => $this->getGeneralexpenses(),
            $keys[9] => $this->getElecexpenses(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Fishpandl
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setSalesincome($value);
                break;
            case 4:
                $this->setOtherincome($value);
                break;
            case 5:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setSalesincome($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setOtherincome($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setPurchases($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setOtherpurchases($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setLabourparttimeexpense($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setGeneralexpenses($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setElecexpenses($arr[$keys[9]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Fishpandl The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FishpandlTableMap::COL_OID)) {
            $criteria->add(FishpandlTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_LINEOFBUSINESSOID)) {
            $criteria->add(FishpandlTableMap::COL_LINEOFBUSINESSOID, $this->lineofbusinessoid);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_OPSMONTHLYCALENDAROID)) {
            $criteria->add(FishpandlTableMap::COL_OPSMONTHLYCALENDAROID, $this->opsmonthlycalendaroid);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_SALESINCOME)) {
            $criteria->add(FishpandlTableMap::COL_SALESINCOME, $this->salesincome);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_OTHERINCOME)) {
            $criteria->add(FishpandlTableMap::COL_OTHERINCOME, $this->otherincome);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_PURCHASES)) {
            $criteria->add(FishpandlTableMap::COL_PURCHASES, $this->purchases);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_OTHERPURCHASES)) {
            $criteria->add(FishpandlTableMap::COL_OTHERPURCHASES, $this->otherpurchases);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_LABOURPARTTIMEEXPENSE)) {
            $criteria->add(FishpandlTableMap::COL_LABOURPARTTIMEEXPENSE, $this->labourparttimeexpense);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_GENERALEXPENSES)) {
            $criteria->add(FishpandlTableMap::COL_GENERALEXPENSES, $this->generalexpenses);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_ELECEXPENSES)) {
            $criteria->add(FishpandlTableMap::COL_ELECEXPENSES, $this->elecexpenses);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_CREATETMSTP)) {
            $criteria->add(FishpandlTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(FishpandlTableMap::COL_UPDTTMSTP)) {
            $criteria->add(FishpandlTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildFishpandlQuery::create();
        $criteria->add(FishpandlTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Fishpandl (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSalesincome($this->getSalesincome());
        $copyObj->setOtherincome($this->getOtherincome());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Fishpandl Clone of current object.
     * @throws PropelException
     */
    ...
    public function getLineofbusiness(ConnectionInterface $con = null)
    {
        if ($this->aLineofbusiness === null && ($this->lineofbusinessoid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLineofbusiness->addFishpandls($this);
             */
        }
    ...
    public function getOpsmonthlycalendar(ConnectionInterface $con = null)
    {
        if ($this->aOpsmonthlycalendar === null && ($this->opsmonthlycalendaroid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOpsmonthlycalendar->addFishpandls($this);
             */
        }
     ...
     * If this ChildFishpandl is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildFishpandl The current object (for fluent API support)
     */
    public function setFishpandllabourexpensedetails(Collection $fishpandllabourexpensedetails, ConnectionInterface $con = null)
    {
        ...
        foreach ($fishpandllabourexpensedetailsToDelete as $fishpandllabourexpensedetailRemoved) {
            $fishpandllabourexpensedetailRemoved->setFishpandl(null);
        }
    ...
    protected function doAddFishpandllabourexpensedetail(ChildFishpandllabourexpensedetail $fishpandllabourexpensedetail)
    {
        ...
        $fishpandllabourexpensedetail->setFishpandl($this);
    }
    ...
    public function removeFishpandllabourexpensedetail(ChildFishpandllabourexpensedetail $fishpandllabourexpensedetail)
    {
        if ($this->getFishpandllabourexpensedetails()->contains($fishpandllabourexpensedetail)) {
            ...
            $fishpandllabourexpensedetail->setFishpandl(null);
        }
     ...
     * Otherwise if this Fishpandl is new, it will return
     * an empty collection; or if this Fishpandl has previously
     * been saved, it will retrieve related Fishpandllabourexpensedetails from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Fishpandl.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildFishpandllabourexpensedetail[] List of ChildFishpandllabourexpensedetail objects
     */
    public function getFishpandllabourexpensedetailsJoinEmployeeroletype(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildFishpandllabourexpensedetailQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aLineofbusiness) {
            $this->aLineofbusiness->removeFishpandl($this);
        }
        if (null !== $this->aOpsmonthlycalendar) {
            $this->aOpsmonthlycalendar->removeFishpandl($this);
        }
        $this->oid = null;
        $this->lineofbusinessoid = null;
        $this->opsmonthlycalendaroid = null;
        $this->salesincome = null;
    ...
    {
        return (string) $this->exportTo(FishpandlTableMap::DEFAULT_STRING_FORMAT);
    }
