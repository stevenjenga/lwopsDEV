...
/**
 * Base class that represents a row from the 'opsbiweeklycalendar' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Opsbiweeklycalendar implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\OpsbiweeklycalendarTableMap';
    ...
    /**
     * The value for the periodstartdate field.
     *
     * @var        DateTime
     */
    ...
    /**
     * The value for the periodenddt field.
     *
     * @var        DateTime
     */
    protected $periodenddt;
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Opsbiweeklycalendar object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Opsbiweeklycalendar</code> instance.  If
     * <code>obj</code> is an instance of <code>Opsbiweeklycalendar</code>, delegates to
     * <code>equals(Opsbiweeklycalendar)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Opsbiweeklycalendar The current object, for fluid interface
     */
    ...
    /**
     * Get the [optionally formatted] temporal [periodstartdate] column value.
     *
     *
     ...
     */
    public function getPeriodstartdate($format = NULL)
    {
        if ($format === null) {
            return $this->periodstartdate;
        } else {
            return $this->periodstartdate instanceof \DateTimeInterface ? $this->periodstartdate->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [periodenddt] column value.
     *
     *
     * @param      string $format The date/time format string (either date()-style or strftime()-style).
     *                            If format is NULL, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getPeriodenddt($format = NULL)
    {
        if ($format === null) {
            return $this->periodenddt;
        } else {
            return $this->periodenddt instanceof \DateTimeInterface ? $this->periodenddt->format($format) : null;
        }
    }
     ...
     * @return $this|\lwops\lwops\Opsbiweeklycalendar The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[OpsbiweeklycalendarTableMap::COL_OID] = true;
        }
    ...
    /**
     * Sets the value of [periodstartdate] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\lwops\lwops\Opsbiweeklycalendar The current object (for fluent API support)
     */
    public function setPeriodstartdate($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->periodstartdate !== null || $dt !== null) {
            if ($this->periodstartdate === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->periodstartdate->format("Y-m-d H:i:s.u")) {
                $this->periodstartdate = $dt === null ? null : clone $dt;
                $this->modifiedColumns[OpsbiweeklycalendarTableMap::COL_PERIODSTARTDATE] = true;
            }
    ...
    /**
     * Sets the value of [periodenddt] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\lwops\lwops\Opsbiweeklycalendar The current object (for fluent API support)
     */
    public function setPeriodenddt($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->periodenddt !== null || $dt !== null) {
            if ($this->periodenddt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->periodenddt->format("Y-m-d H:i:s.u")) {
                $this->periodenddt = $dt === null ? null : clone $dt;
                $this->modifiedColumns[OpsbiweeklycalendarTableMap::COL_PERIODENDDT] = true;
            }
        } // if either are not null
    ...
    public function setPaydate($v)
    {
        ...
        if ($this->paydate !== null || $dt !== null) {
            if ($this->paydate === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->paydate->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OpsbiweeklycalendarTableMap::COL_PAYDATE] = true;
            }
        } // if either are not null
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OpsbiweeklycalendarTableMap::COL_CREATETMSTP] = true;
            }
        } // if either are not null
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OpsbiweeklycalendarTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OpsbiweeklycalendarTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OpsbiweeklycalendarTableMap::translateFieldName('Periodstartdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->periodstartdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OpsbiweeklycalendarTableMap::translateFieldName('Periodenddt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->periodenddt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OpsbiweeklycalendarTableMap::translateFieldName('Paydate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->paydate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OpsbiweeklycalendarTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OpsbiweeklycalendarTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = OpsbiweeklycalendarTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Opsbiweeklycalendar'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOpsbiweeklycalendarQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Opsbiweeklycalendar::setDeleted()
     * @see Opsbiweeklycalendar::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOpsbiweeklycalendarQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OpsbiweeklycalendarTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_PERIODSTARTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'periodStartDate';
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_PERIODENDDT)) {
            $modifiedColumns[':p' . $index++]  = 'periodEndDt';
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_PAYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'payDate';
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO opsbiweeklycalendar (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'periodStartDate':
                        $stmt->bindValue($identifier, $this->periodstartdate ? $this->periodstartdate->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'periodEndDt':
                        $stmt->bindValue($identifier, $this->periodenddt ? $this->periodenddt->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'payDate':
    ...
    {
        $pos = OpsbiweeklycalendarTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Opsbiweeklycalendar'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Opsbiweeklycalendar'][$this->hashCode()] = true;
        $keys = OpsbiweeklycalendarTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
            $keys[1] => $this->getPeriodstartdate(),
            $keys[2] => $this->getPeriodenddt(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Opsbiweeklycalendar
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setPeriodstartdate($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setPeriodenddt($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Opsbiweeklycalendar The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_OID)) {
            $criteria->add(OpsbiweeklycalendarTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_PERIODSTARTDATE)) {
            $criteria->add(OpsbiweeklycalendarTableMap::COL_PERIODSTARTDATE, $this->periodstartdate);
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_PERIODENDDT)) {
            $criteria->add(OpsbiweeklycalendarTableMap::COL_PERIODENDDT, $this->periodenddt);
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_PAYDATE)) {
            $criteria->add(OpsbiweeklycalendarTableMap::COL_PAYDATE, $this->paydate);
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_CREATETMSTP)) {
            $criteria->add(OpsbiweeklycalendarTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(OpsbiweeklycalendarTableMap::COL_UPDTTMSTP)) {
            $criteria->add(OpsbiweeklycalendarTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildOpsbiweeklycalendarQuery::create();
        $criteria->add(OpsbiweeklycalendarTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Opsbiweeklycalendar (or compatible) type.
    ...
    {
        $copyObj->setPeriodstartdate($this->getPeriodstartdate());
        $copyObj->setPeriodenddt($this->getPeriodenddt());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Opsbiweeklycalendar Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildOpsbiweeklycalendar is new, it will return
        ...
        if (null === $this->collCasualemployeepayslips || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCasualemployeepayslips) {
                ...
                $collCasualemployeepayslips = ChildCasualemployeepayslipQuery::create(null, $criteria)
                    ->filterByOpsbiweeklycalendar($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildOpsbiweeklycalendar The current object (for fluent API support)
     */
    public function setCasualemployeepayslips(Collection $casualemployeepayslips, ConnectionInterface $con = null)
    {
        ...
        foreach ($casualemployeepayslipsToDelete as $casualemployeepayslipRemoved) {
            $casualemployeepayslipRemoved->setOpsbiweeklycalendar(null);
        }
    ...
    protected function doAddCasualemployeepayslip(ChildCasualemployeepayslip $casualemployeepayslip)
    {
        ...
        $casualemployeepayslip->setOpsbiweeklycalendar($this);
    }
    ...
    public function removeCasualemployeepayslip(ChildCasualemployeepayslip $casualemployeepayslip)
    {
        if ($this->getCasualemployeepayslips()->contains($casualemployeepayslip)) {
            ...
            $casualemployeepayslip->setOpsbiweeklycalendar(null);
        }
     ...
     * Otherwise if this Opsbiweeklycalendar is new, it will return
     * an empty collection; or if this Opsbiweeklycalendar has previously
     * been saved, it will retrieve related Casualemployeepayslips from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Opsbiweeklycalendar.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildCasualemployeepayslip[] List of ChildCasualemployeepayslip objects
     */
    public function getCasualemployeepayslipsJoinEmployee(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCasualemployeepayslipQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(OpsbiweeklycalendarTableMap::DEFAULT_STRING_FORMAT);
    }
