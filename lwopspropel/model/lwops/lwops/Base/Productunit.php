...
/**
 * Base class that represents a row from the 'productunit' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Productunit implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\ProductunitTableMap';
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Productunit object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Productunit</code> instance.  If
     * <code>obj</code> is an instance of <code>Productunit</code>, delegates to
     * <code>equals(Productunit)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Productunit The current object, for fluid interface
     */
     ...
     * @return $this|\lwops\lwops\Productunit The current object (for fluent API support)
     */
    public function setUnit($v)
    {
        ...
        if ($this->unit !== $v) {
            $this->unit = $v;
            $this->modifiedColumns[ProductunitTableMap::COL_UNIT] = true;
        }
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ProductunitTableMap::COL_CREATETMSTP] = true;
            }
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ProductunitTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductunitTableMap::translateFieldName('Unit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unit = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductunitTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductunitTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 3; // 3 = ProductunitTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Productunit'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProductunitQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Productunit::setDeleted()
     * @see Productunit::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildProductunitQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductunitTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductunitTableMap::COL_UNIT)) {
            $modifiedColumns[':p' . $index++]  = 'unit';
        }
        if ($this->isColumnModified(ProductunitTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(ProductunitTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO productunit (%s) VALUES (%s)',
    ...
    {
        $pos = ProductunitTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Productunit'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Productunit'][$this->hashCode()] = true;
        $keys = ProductunitTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getUnit(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Productunit
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Productunit The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductunitTableMap::COL_UNIT)) {
            $criteria->add(ProductunitTableMap::COL_UNIT, $this->unit);
        }
        if ($this->isColumnModified(ProductunitTableMap::COL_CREATETMSTP)) {
            $criteria->add(ProductunitTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(ProductunitTableMap::COL_UPDTTMSTP)) {
            $criteria->add(ProductunitTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildProductunitQuery::create();
        $criteria->add(ProductunitTableMap::COL_UNIT, $this->unit);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Productunit (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Productunit Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildProductunit is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildProductunit The current object (for fluent API support)
     */
    public function setEmployeepurchasess(Collection $employeepurchasess, ConnectionInterface $con = null)
    {
        ...
        foreach ($employeepurchasessToDelete as $employeepurchasesRemoved) {
            $employeepurchasesRemoved->setProductunit(null);
        }
    ...
    protected function doAddEmployeepurchases(ChildEmployeepurchases $employeepurchases)
    {
        ...
        $employeepurchases->setProductunit($this);
    }
    ...
    public function removeEmployeepurchases(ChildEmployeepurchases $employeepurchases)
    {
        if ($this->getEmployeepurchasess()->contains($employeepurchases)) {
            ...
            $employeepurchases->setProductunit(null);
        }
     ...
     * Otherwise if this Productunit is new, it will return
     * an empty collection; or if this Productunit has previously
     * been saved, it will retrieve related Employeepurchasess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Productunit.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ProductunitTableMap::DEFAULT_STRING_FORMAT);
    }
