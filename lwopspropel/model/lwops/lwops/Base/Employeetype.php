...
/**
 * Base class that represents a row from the 'employeetype' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Employeetype implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\EmployeetypeTableMap';
     ...
     *
     * Note: this column has a database default value of: 'Casual Labourer'
     * @var        string
     */
    ...
    {
        $this->type = 'C';
        $this->description = 'Casual Labourer';
    }

    /**
     * Initializes internal state of lwops\lwops\Base\Employeetype object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Employeetype</code> instance.  If
     * <code>obj</code> is an instance of <code>Employeetype</code>, delegates to
     * <code>equals(Employeetype)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Employeetype The current object, for fluid interface
     */
     ...
     * @return $this|\lwops\lwops\Employeetype The current object (for fluent API support)
     */
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[EmployeetypeTableMap::COL_TYPE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[EmployeetypeTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EmployeetypeTableMap::COL_CREATETMSTP] = true;
            }
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EmployeetypeTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->description !== 'Casual Labourer') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EmployeetypeTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EmployeetypeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EmployeetypeTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EmployeetypeTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = EmployeetypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Employeetype'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEmployeetypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Employeetype::setDeleted()
     * @see Employeetype::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEmployeetypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EmployeetypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EmployeetypeTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(EmployeetypeTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(EmployeetypeTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(EmployeetypeTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO employeetype (%s) VALUES (%s)',
    ...
    {
        $pos = EmployeetypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Employeetype'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Employeetype'][$this->hashCode()] = true;
        $keys = EmployeetypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getType(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Employeetype
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Employeetype The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmployeetypeTableMap::COL_TYPE)) {
            $criteria->add(EmployeetypeTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(EmployeetypeTableMap::COL_DESCRIPTION)) {
            $criteria->add(EmployeetypeTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(EmployeetypeTableMap::COL_CREATETMSTP)) {
            $criteria->add(EmployeetypeTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(EmployeetypeTableMap::COL_UPDTTMSTP)) {
            $criteria->add(EmployeetypeTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildEmployeetypeQuery::create();
        $criteria->add(EmployeetypeTableMap::COL_TYPE, $this->type);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Employeetype (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Employeetype Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildEmployeetype is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEmployeetype The current object (for fluent API support)
     */
    public function setSalaries(Collection $salaries, ConnectionInterface $con = null)
    {
        ...
        foreach ($salariesToDelete as $salaryRemoved) {
            $salaryRemoved->setEmployeetype(null);
        }
     ...
     * Otherwise if this Employeetype is new, it will return
     * an empty collection; or if this Employeetype has previously
     * been saved, it will retrieve related Salaries from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Employeetype.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildSalary[] List of ChildSalary objects
     */
    public function getSalariesJoinEmployee(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSalaryQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(EmployeetypeTableMap::DEFAULT_STRING_FORMAT);
    }
