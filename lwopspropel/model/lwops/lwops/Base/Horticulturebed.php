...
/**
 * Base class that represents a row from the 'horticulturebed' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Horticulturebed implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\HorticulturebedTableMap';
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Horticulturebed object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Horticulturebed</code> instance.  If
     * <code>obj</code> is an instance of <code>Horticulturebed</code>, delegates to
     * <code>equals(Horticulturebed)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Horticulturebed The current object, for fluid interface
     */
     ...
     * @return $this|\lwops\lwops\Horticulturebed The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[HorticulturebedTableMap::COL_OID] = true;
        }
    ...
    public function setIdentifier($v)
    {
        ...
        if ($this->identifier !== $v) {
            $this->identifier = $v;
            $this->modifiedColumns[HorticulturebedTableMap::COL_IDENTIFIER] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[HorticulturebedTableMap::COL_TYPE] = true;
        }
    ...
    public function setLength($v)
    {
        ...
        if ($this->length !== $v) {
            $this->length = $v;
            $this->modifiedColumns[HorticulturebedTableMap::COL_LENGTH] = true;
        }
    ...
    public function setWidth($v)
    {
        ...
        if ($this->width !== $v) {
            $this->width = $v;
            $this->modifiedColumns[HorticulturebedTableMap::COL_WIDTH] = true;
        }
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[HorticulturebedTableMap::COL_UPDTTMSTP] = true;
            }
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[HorticulturebedTableMap::COL_CREATETMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : HorticulturebedTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : HorticulturebedTableMap::translateFieldName('Identifier', TableMap::TYPE_PHPNAME, $indexType)];
            $this->identifier = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : HorticulturebedTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : HorticulturebedTableMap::translateFieldName('Length', TableMap::TYPE_PHPNAME, $indexType)];
            $this->length = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : HorticulturebedTableMap::translateFieldName('Width', TableMap::TYPE_PHPNAME, $indexType)];
            $this->width = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : HorticulturebedTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updttmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : HorticulturebedTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = HorticulturebedTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Horticulturebed'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildHorticulturebedQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Horticulturebed::setDeleted()
     * @see Horticulturebed::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHorticulturebedQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HorticulturebedTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[HorticulturebedTableMap::COL_OID] = true;
        if (null !== $this->oid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . HorticulturebedTableMap::COL_OID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(HorticulturebedTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_IDENTIFIER)) {
            $modifiedColumns[':p' . $index++]  = 'identifier';
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_LENGTH)) {
            $modifiedColumns[':p' . $index++]  = 'length';
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_WIDTH)) {
            $modifiedColumns[':p' . $index++]  = 'width';
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }

        $sql = sprintf(
            'INSERT INTO horticulturebed (%s) VALUES (%s)',
    ...
    {
        $pos = HorticulturebedTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Horticulturebed'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Horticulturebed'][$this->hashCode()] = true;
        $keys = HorticulturebedTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Horticulturebed
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Horticulturebed The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(HorticulturebedTableMap::DATABASE_NAME);

        if ($this->isColumnModified(HorticulturebedTableMap::COL_OID)) {
            $criteria->add(HorticulturebedTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_IDENTIFIER)) {
            $criteria->add(HorticulturebedTableMap::COL_IDENTIFIER, $this->identifier);
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_TYPE)) {
            $criteria->add(HorticulturebedTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_LENGTH)) {
            $criteria->add(HorticulturebedTableMap::COL_LENGTH, $this->length);
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_WIDTH)) {
            $criteria->add(HorticulturebedTableMap::COL_WIDTH, $this->width);
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_UPDTTMSTP)) {
            $criteria->add(HorticulturebedTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
        if ($this->isColumnModified(HorticulturebedTableMap::COL_CREATETMSTP)) {
            $criteria->add(HorticulturebedTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
    ...
    {
        $criteria = ChildHorticulturebedQuery::create();
        $criteria->add(HorticulturebedTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Horticulturebed (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Horticulturebed Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildHorticulturebed is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildHorticulturebed The current object (for fluent API support)
     */
    public function setHorticultureproducebeds(Collection $horticultureproducebeds, ConnectionInterface $con = null)
    {
        ...
        foreach ($horticultureproducebedsToDelete as $horticultureproducebedRemoved) {
            $horticultureproducebedRemoved->setHorticulturebed(null);
        }
    ...
    protected function doAddHorticultureproducebed(ChildHorticultureproducebed $horticultureproducebed)
    {
        ...
        $horticultureproducebed->setHorticulturebed($this);
    }
    ...
    public function removeHorticultureproducebed(ChildHorticultureproducebed $horticultureproducebed)
    {
        if ($this->getHorticultureproducebeds()->contains($horticultureproducebed)) {
            ...
            $horticultureproducebed->setHorticulturebed(null);
        }
     ...
     * Otherwise if this Horticulturebed is new, it will return
     * an empty collection; or if this Horticulturebed has previously
     * been saved, it will retrieve related Horticultureproducebeds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Horticulturebed.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildHorticultureproducebed[] List of ChildHorticultureproducebed objects
     */
    public function getHorticultureproducebedsJoinHorticultureproducedetail(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildHorticultureproducebedQuery::create(null, $criteria);
        $query->joinWith('Horticultureproducedetail', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(HorticulturebedTableMap::DEFAULT_STRING_FORMAT);
    }
