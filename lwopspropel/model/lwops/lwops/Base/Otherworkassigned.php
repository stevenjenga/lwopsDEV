...
/**
 * Base class that represents a row from the 'otherworkassigned' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Otherworkassigned implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\OtherworkassignedTableMap';
     ...
     *
     * Note: this column has a database default value of: 11
     * @var        int
     */
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Otherworkassigned object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Otherworkassigned</code> instance.  If
     * <code>obj</code> is an instance of <code>Otherworkassigned</code>, delegates to
     * <code>equals(Otherworkassigned)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Otherworkassigned The current object, for fluid interface
     */
     ...
     * @return $this|\lwops\lwops\Otherworkassigned The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[OtherworkassignedTableMap::COL_OID] = true;
        }
    ...
    public function setAttendanceoid($v)
    {
        ...
        if ($this->attendanceoid !== $v) {
            ...
            $this->modifiedColumns[OtherworkassignedTableMap::COL_ATTENDANCEOID] = true;
        }
    ...
    public function setLineofbusinessoid($v)
    {
        ...
        if ($this->lineofbusinessoid !== $v) {
            ...
            $this->modifiedColumns[OtherworkassignedTableMap::COL_LINEOFBUSINESSOID] = true;
        }
    ...
    public function setStarttm($v)
    {
        ...
        if ($this->starttm !== null || $dt !== null) {
            if ( ($dt != $this->starttm) // normalized values don't match
                ...
                $this->modifiedColumns[OtherworkassignedTableMap::COL_STARTTM] = true;
            }
    ...
    public function setEndtm($v)
    {
        ...
        if ($this->endtm !== null || $dt !== null) {
            if ( ($dt != $this->endtm) // normalized values don't match
                ...
                $this->modifiedColumns[OtherworkassignedTableMap::COL_ENDTM] = true;
            }
        } // if either are not null
    ...
    public function setHours($v)
    {
        ...
        if ($this->hours !== $v) {
            $this->hours = $v;
            $this->modifiedColumns[OtherworkassignedTableMap::COL_HOURS] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[OtherworkassignedTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setRemarks($v)
    {
        ...
        if ($this->remarks !== $v) {
            $this->remarks = $v;
            $this->modifiedColumns[OtherworkassignedTableMap::COL_REMARKS] = true;
        }
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OtherworkassignedTableMap::COL_CREATETMSTP] = true;
            }
        } // if either are not null
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OtherworkassignedTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OtherworkassignedTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OtherworkassignedTableMap::translateFieldName('Attendanceoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->attendanceoid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OtherworkassignedTableMap::translateFieldName('Lineofbusinessoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lineofbusinessoid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OtherworkassignedTableMap::translateFieldName('Starttm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->starttm = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OtherworkassignedTableMap::translateFieldName('Endtm', TableMap::TYPE_PHPNAME, $indexType)];
            $this->endtm = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OtherworkassignedTableMap::translateFieldName('Hours', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hours = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : OtherworkassignedTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : OtherworkassignedTableMap::translateFieldName('Remarks', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remarks = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : OtherworkassignedTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : OtherworkassignedTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 10; // 10 = OtherworkassignedTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Otherworkassigned'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOtherworkassignedQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Otherworkassigned::setDeleted()
     * @see Otherworkassigned::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOtherworkassignedQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OtherworkassignedTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[OtherworkassignedTableMap::COL_OID] = true;
        if (null !== $this->oid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . OtherworkassignedTableMap::COL_OID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_ATTENDANCEOID)) {
            $modifiedColumns[':p' . $index++]  = 'attendanceOid';
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_LINEOFBUSINESSOID)) {
            $modifiedColumns[':p' . $index++]  = 'lineOfBusinessOid';
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_STARTTM)) {
            $modifiedColumns[':p' . $index++]  = 'startTm';
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_ENDTM)) {
            $modifiedColumns[':p' . $index++]  = 'endTm';
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_HOURS)) {
            $modifiedColumns[':p' . $index++]  = 'hours';
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_REMARKS)) {
            $modifiedColumns[':p' . $index++]  = 'remarks';
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO otherworkassigned (%s) VALUES (%s)',
    ...
    {
        $pos = OtherworkassignedTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Otherworkassigned'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Otherworkassigned'][$this->hashCode()] = true;
        $keys = OtherworkassignedTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
            $keys[1] => $this->getAttendanceoid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Otherworkassigned
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setAttendanceoid($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Otherworkassigned The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(OtherworkassignedTableMap::DATABASE_NAME);

        if ($this->isColumnModified(OtherworkassignedTableMap::COL_OID)) {
            $criteria->add(OtherworkassignedTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_ATTENDANCEOID)) {
            $criteria->add(OtherworkassignedTableMap::COL_ATTENDANCEOID, $this->attendanceoid);
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_LINEOFBUSINESSOID)) {
            $criteria->add(OtherworkassignedTableMap::COL_LINEOFBUSINESSOID, $this->lineofbusinessoid);
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_STARTTM)) {
            $criteria->add(OtherworkassignedTableMap::COL_STARTTM, $this->starttm);
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_ENDTM)) {
            $criteria->add(OtherworkassignedTableMap::COL_ENDTM, $this->endtm);
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_HOURS)) {
            $criteria->add(OtherworkassignedTableMap::COL_HOURS, $this->hours);
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_DESCRIPTION)) {
            $criteria->add(OtherworkassignedTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_REMARKS)) {
            $criteria->add(OtherworkassignedTableMap::COL_REMARKS, $this->remarks);
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_CREATETMSTP)) {
            $criteria->add(OtherworkassignedTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(OtherworkassignedTableMap::COL_UPDTTMSTP)) {
            $criteria->add(OtherworkassignedTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildOtherworkassignedQuery::create();
        $criteria->add(OtherworkassignedTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Otherworkassigned (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Otherworkassigned Clone of current object.
     * @throws PropelException
     */
    ...
    public function getAttendance(ConnectionInterface $con = null)
    {
        if ($this->aAttendance === null && ($this->attendanceoid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAttendance->addOtherworkassigneds($this);
             */
        }
    ...
    public function getLineofbusiness(ConnectionInterface $con = null)
    {
        if ($this->aLineofbusiness === null && ($this->lineofbusinessoid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLineofbusiness->addOtherworkassigneds($this);
             */
        }
    ...
    {
        if (null !== $this->aAttendance) {
            $this->aAttendance->removeOtherworkassigned($this);
        }
        if (null !== $this->aLineofbusiness) {
            $this->aLineofbusiness->removeOtherworkassigned($this);
        }
        $this->oid = null;
    ...
    {
        return (string) $this->exportTo(OtherworkassignedTableMap::DEFAULT_STRING_FORMAT);
    }
