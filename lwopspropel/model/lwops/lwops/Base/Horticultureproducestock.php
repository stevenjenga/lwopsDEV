...
/**
 * Base class that represents a row from the 'horticultureproducestock' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Horticultureproducestock implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\HorticultureproducestockTableMap';
    ...
    /**
     * The value for the stockdate field.
     *
     * @var        DateTime
     */
    protected $stockdate;
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Horticultureproducestock object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Horticultureproducestock</code> instance.  If
     * <code>obj</code> is an instance of <code>Horticultureproducestock</code>, delegates to
     * <code>equals(Horticultureproducestock)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Horticultureproducestock The current object, for fluid interface
     */
    ...
    /**
     * Get the [optionally formatted] temporal [stockdate] column value.
     *
     *
     ...
     */
    public function getStockdate($format = NULL)
    {
        if ($format === null) {
            return $this->stockdate;
        } else {
            return $this->stockdate instanceof \DateTimeInterface ? $this->stockdate->format($format) : null;
        }
    }
     ...
     * @return $this|\lwops\lwops\Horticultureproducestock The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[HorticultureproducestockTableMap::COL_OID] = true;
        }
    ...
    public function setProducetypeoid($v)
    {
        ...
        if ($this->producetypeoid !== $v) {
            ...
            $this->modifiedColumns[HorticultureproducestockTableMap::COL_PRODUCETYPEOID] = true;
        }
    ...
    /**
     * Sets the value of [stockdate] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\lwops\lwops\Horticultureproducestock The current object (for fluent API support)
     */
    public function setStockdate($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->stockdate !== null || $dt !== null) {
            if ($this->stockdate === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->stockdate->format("Y-m-d H:i:s.u")) {
                $this->stockdate = $dt === null ? null : clone $dt;
                $this->modifiedColumns[HorticultureproducestockTableMap::COL_STOCKDATE] = true;
            }
    ...
    public function setQty($v)
    {
        ...
        if ($this->qty !== $v) {
            $this->qty = $v;
            $this->modifiedColumns[HorticultureproducestockTableMap::COL_QTY] = true;
        }
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[HorticultureproducestockTableMap::COL_CREATETMSTP] = true;
            }
        } // if either are not null
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[HorticultureproducestockTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : HorticultureproducestockTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : HorticultureproducestockTableMap::translateFieldName('Producetypeoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->producetypeoid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : HorticultureproducestockTableMap::translateFieldName('Stockdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->stockdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : HorticultureproducestockTableMap::translateFieldName('Qty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qty = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : HorticultureproducestockTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : HorticultureproducestockTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = HorticultureproducestockTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Horticultureproducestock'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildHorticultureproducestockQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Horticultureproducestock::setDeleted()
     * @see Horticultureproducestock::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHorticultureproducestockQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HorticultureproducestockTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_PRODUCETYPEOID)) {
            $modifiedColumns[':p' . $index++]  = 'produceTypeOid';
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_STOCKDATE)) {
            $modifiedColumns[':p' . $index++]  = 'stockDate';
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'qty';
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO horticultureproducestock (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'produceTypeOid':
                        ...
                        break;
                    case 'stockDate':
                        $stmt->bindValue($identifier, $this->stockdate ? $this->stockdate->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'qty':
    ...
    {
        $pos = HorticultureproducestockTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Horticultureproducestock'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Horticultureproducestock'][$this->hashCode()] = true;
        $keys = HorticultureproducestockTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
            $keys[1] => $this->getProducetypeoid(),
            $keys[2] => $this->getStockdate(),
            $keys[3] => $this->getQty(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Horticultureproducestock
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Horticultureproducestock The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_OID)) {
            $criteria->add(HorticultureproducestockTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_PRODUCETYPEOID)) {
            $criteria->add(HorticultureproducestockTableMap::COL_PRODUCETYPEOID, $this->producetypeoid);
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_STOCKDATE)) {
            $criteria->add(HorticultureproducestockTableMap::COL_STOCKDATE, $this->stockdate);
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_QTY)) {
            $criteria->add(HorticultureproducestockTableMap::COL_QTY, $this->qty);
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_CREATETMSTP)) {
            $criteria->add(HorticultureproducestockTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(HorticultureproducestockTableMap::COL_UPDTTMSTP)) {
            $criteria->add(HorticultureproducestockTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildHorticultureproducestockQuery::create();
        $criteria->add(HorticultureproducestockTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Horticultureproducestock (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setStockdate($this->getStockdate());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Horticultureproducestock Clone of current object.
     * @throws PropelException
     */
    ...
    public function setHorticultureproducedetail(ChildHorticultureproducedetail $v = null)
    {
        ...
        if ($v !== null) {
            $v->addHorticultureproducestock($this);
        }
    ...
    public function getHorticultureproducedetail(ConnectionInterface $con = null)
    {
        if ($this->aHorticultureproducedetail === null && ($this->producetypeoid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aHorticultureproducedetail->addHorticultureproducestocks($this);
             */
        }
    ...
    {
        if (null !== $this->aHorticultureproducedetail) {
            $this->aHorticultureproducedetail->removeHorticultureproducestock($this);
        }
        $this->oid = null;
    ...
    {
        return (string) $this->exportTo(HorticultureproducestockTableMap::DEFAULT_STRING_FORMAT);
    }
