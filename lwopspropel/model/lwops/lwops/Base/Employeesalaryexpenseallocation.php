...
/**
 * Base class that represents a row from the 'employeesalaryexpenseallocation' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Employeesalaryexpenseallocation implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\EmployeesalaryexpenseallocationTableMap';
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Employeesalaryexpenseallocation object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Employeesalaryexpenseallocation</code> instance.  If
     * <code>obj</code> is an instance of <code>Employeesalaryexpenseallocation</code>, delegates to
     * <code>equals(Employeesalaryexpenseallocation)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Employeesalaryexpenseallocation The current object, for fluid interface
     */
     ...
     * @return $this|\lwops\lwops\Employeesalaryexpenseallocation The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[EmployeesalaryexpenseallocationTableMap::COL_OID] = true;
        }
    ...
    public function setEmployeeoid($v)
    {
        ...
        if ($this->employeeoid !== $v) {
            $this->employeeoid = $v;
            $this->modifiedColumns[EmployeesalaryexpenseallocationTableMap::COL_EMPLOYEEOID] = true;
        }
    ...
    public function setLineofbusinessoid($v)
    {
        ...
        if ($this->lineofbusinessoid !== $v) {
            ...
            $this->modifiedColumns[EmployeesalaryexpenseallocationTableMap::COL_LINEOFBUSINESSOID] = true;
        }
    ...
    public function setAllocation($v)
    {
        ...
        if ($this->allocation !== $v) {
            $this->allocation = $v;
            $this->modifiedColumns[EmployeesalaryexpenseallocationTableMap::COL_ALLOCATION] = true;
        }
    ...
    public function setEffectivedt($v)
    {
        ...
        if ($this->effectivedt !== null || $dt !== null) {
            if ($this->effectivedt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->effectivedt->format("Y-m-d H:i:s.u")) {
                $this->effectivedt = $dt === null ? null : clone $dt;
                $this->modifiedColumns[EmployeesalaryexpenseallocationTableMap::COL_EFFECTIVEDT] = true;
            }
    ...
    public function setEnddt($v)
    {
        ...
        if ($this->enddt !== null || $dt !== null) {
            if ($this->enddt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->enddt->format("Y-m-d H:i:s.u")) {
                $this->enddt = $dt === null ? null : clone $dt;
                $this->modifiedColumns[EmployeesalaryexpenseallocationTableMap::COL_ENDDT] = true;
            }
        } // if either are not null
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EmployeesalaryexpenseallocationTableMap::COL_CREATETMSTP] = true;
            }
        } // if either are not null
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EmployeesalaryexpenseallocationTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EmployeesalaryexpenseallocationTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EmployeesalaryexpenseallocationTableMap::translateFieldName('Employeeoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employeeoid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EmployeesalaryexpenseallocationTableMap::translateFieldName('Lineofbusinessoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lineofbusinessoid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EmployeesalaryexpenseallocationTableMap::translateFieldName('Allocation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->allocation = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EmployeesalaryexpenseallocationTableMap::translateFieldName('Effectivedt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->effectivedt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EmployeesalaryexpenseallocationTableMap::translateFieldName('Enddt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->enddt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EmployeesalaryexpenseallocationTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : EmployeesalaryexpenseallocationTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = EmployeesalaryexpenseallocationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Employeesalaryexpenseallocation'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEmployeesalaryexpenseallocationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Employeesalaryexpenseallocation::setDeleted()
     * @see Employeesalaryexpenseallocation::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEmployeesalaryexpenseallocationQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EmployeesalaryexpenseallocationTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_EMPLOYEEOID)) {
            $modifiedColumns[':p' . $index++]  = 'employeeOid';
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_LINEOFBUSINESSOID)) {
            $modifiedColumns[':p' . $index++]  = 'lineOfBusinessOid';
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_ALLOCATION)) {
            $modifiedColumns[':p' . $index++]  = 'allocation';
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_EFFECTIVEDT)) {
            $modifiedColumns[':p' . $index++]  = 'effectiveDt';
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_ENDDT)) {
            $modifiedColumns[':p' . $index++]  = 'endDt';
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO employeesalaryexpenseallocation (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'lineOfBusinessOid':
                        ...
                        break;
                    case 'allocation':
                        $stmt->bindValue($identifier, $this->allocation, PDO::PARAM_STR);
                        break;
                    case 'effectiveDt':
    ...
    {
        $pos = EmployeesalaryexpenseallocationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Employeesalaryexpenseallocation'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Employeesalaryexpenseallocation'][$this->hashCode()] = true;
        $keys = EmployeesalaryexpenseallocationTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
            $keys[1] => $this->getEmployeeoid(),
            $keys[2] => $this->getLineofbusinessoid(),
            $keys[3] => $this->getAllocation(),
            $keys[4] => $this->getEffectivedt(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Employeesalaryexpenseallocation
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setLineofbusinessoid($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setAllocation($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setEffectivedt($arr[$keys[4]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Employeesalaryexpenseallocation The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_OID)) {
            $criteria->add(EmployeesalaryexpenseallocationTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_EMPLOYEEOID)) {
            $criteria->add(EmployeesalaryexpenseallocationTableMap::COL_EMPLOYEEOID, $this->employeeoid);
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_LINEOFBUSINESSOID)) {
            $criteria->add(EmployeesalaryexpenseallocationTableMap::COL_LINEOFBUSINESSOID, $this->lineofbusinessoid);
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_ALLOCATION)) {
            $criteria->add(EmployeesalaryexpenseallocationTableMap::COL_ALLOCATION, $this->allocation);
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_EFFECTIVEDT)) {
            $criteria->add(EmployeesalaryexpenseallocationTableMap::COL_EFFECTIVEDT, $this->effectivedt);
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_ENDDT)) {
            $criteria->add(EmployeesalaryexpenseallocationTableMap::COL_ENDDT, $this->enddt);
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_CREATETMSTP)) {
            $criteria->add(EmployeesalaryexpenseallocationTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(EmployeesalaryexpenseallocationTableMap::COL_UPDTTMSTP)) {
            $criteria->add(EmployeesalaryexpenseallocationTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildEmployeesalaryexpenseallocationQuery::create();
        $criteria->add(EmployeesalaryexpenseallocationTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Employeesalaryexpenseallocation (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Employeesalaryexpenseallocation Clone of current object.
     * @throws PropelException
     */
    ...
    public function setEmployee(ChildEmployee $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEmployeesalaryexpenseallocation($this);
        }
    ...
    public function getEmployee(ConnectionInterface $con = null)
    {
        if ($this->aEmployee === null && ($this->employeeoid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmployee->addEmployeesalaryexpenseallocations($this);
             */
        }
    ...
    public function getLineofbusiness(ConnectionInterface $con = null)
    {
        if ($this->aLineofbusiness === null && ($this->lineofbusinessoid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLineofbusiness->addEmployeesalaryexpenseallocations($this);
             */
        }
    ...
    {
        if (null !== $this->aEmployee) {
            $this->aEmployee->removeEmployeesalaryexpenseallocation($this);
        }
        if (null !== $this->aLineofbusiness) {
            $this->aLineofbusiness->removeEmployeesalaryexpenseallocation($this);
        }
        $this->oid = null;
    ...
    {
        return (string) $this->exportTo(EmployeesalaryexpenseallocationTableMap::DEFAULT_STRING_FORMAT);
    }
