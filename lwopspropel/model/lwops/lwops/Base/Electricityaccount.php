...
/**
 * Base class that represents a row from the 'electricityaccount' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Electricityaccount implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\ElectricityaccountTableMap';
    ...
    /**
     * The value for the accountnbr field.
     *
     * Note: this column has a database default value of: '00000'
     * @var        string
     */
    protected $accountnbr;
    ...
    {
        $this->accountnbr = '00000';
    }

    /**
     * Initializes internal state of lwops\lwops\Base\Electricityaccount object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Electricityaccount</code> instance.  If
     * <code>obj</code> is an instance of <code>Electricityaccount</code>, delegates to
     * <code>equals(Electricityaccount)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Electricityaccount The current object, for fluid interface
     */
    ...
    /**
     * Get the [accountnbr] column value.
     *
     * @return string
     */
     ...
     * @return $this|\lwops\lwops\Electricityaccount The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[ElectricityaccountTableMap::COL_OID] = true;
        }
    ...
    /**
     * Set the value of [accountnbr] column.
     *
     * @param string $v new value
     * @return $this|\lwops\lwops\Electricityaccount The current object (for fluent API support)
     */
    public function setAccountnbr($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->accountnbr !== $v) {
            $this->accountnbr = $v;
            $this->modifiedColumns[ElectricityaccountTableMap::COL_ACCOUNTNBR] = true;
        }
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ElectricityaccountTableMap::COL_CREATETMSTP] = true;
            }
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ElectricityaccountTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ElectricityaccountTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ElectricityaccountTableMap::translateFieldName('Accountnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->accountnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ElectricityaccountTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ElectricityaccountTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = ElectricityaccountTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Electricityaccount'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildElectricityaccountQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Electricityaccount::setDeleted()
     * @see Electricityaccount::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildElectricityaccountQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ElectricityaccountTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ElectricityaccountTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(ElectricityaccountTableMap::COL_ACCOUNTNBR)) {
            $modifiedColumns[':p' . $index++]  = 'accountNbr';
        }
        if ($this->isColumnModified(ElectricityaccountTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(ElectricityaccountTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO electricityaccount (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'oid':
                        ...
                        break;
                    case 'accountNbr':
                        $stmt->bindValue($identifier, $this->accountnbr, PDO::PARAM_STR);
                        break;
                    case 'createTmstp':
    ...
    {
        $pos = ElectricityaccountTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Electricityaccount'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Electricityaccount'][$this->hashCode()] = true;
        $keys = ElectricityaccountTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
            $keys[1] => $this->getAccountnbr(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Electricityaccount
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Electricityaccount The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ElectricityaccountTableMap::COL_OID)) {
            $criteria->add(ElectricityaccountTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(ElectricityaccountTableMap::COL_ACCOUNTNBR)) {
            $criteria->add(ElectricityaccountTableMap::COL_ACCOUNTNBR, $this->accountnbr);
        }
        if ($this->isColumnModified(ElectricityaccountTableMap::COL_CREATETMSTP)) {
            $criteria->add(ElectricityaccountTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(ElectricityaccountTableMap::COL_UPDTTMSTP)) {
            $criteria->add(ElectricityaccountTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildElectricityaccountQuery::create();
        $criteria->add(ElectricityaccountTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Electricityaccount (or compatible) type.
    ...
    {
        $copyObj->setAccountnbr($this->getAccountnbr());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Electricityaccount Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildElectricityaccount is new, it will return
        ...
        if (null === $this->collElectricityallocations || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collElectricityallocations) {
                ...
                $collElectricityallocations = ChildElectricityallocationQuery::create(null, $criteria)
                    ->filterByElectricityaccount($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildElectricityaccount The current object (for fluent API support)
     */
    public function setElectricityallocations(Collection $electricityallocations, ConnectionInterface $con = null)
    {
        ...
        foreach ($electricityallocationsToDelete as $electricityallocationRemoved) {
            $electricityallocationRemoved->setElectricityaccount(null);
        }
    ...
    protected function doAddElectricityallocation(ChildElectricityallocation $electricityallocation)
    {
        ...
        $electricityallocation->setElectricityaccount($this);
    }
    ...
    public function removeElectricityallocation(ChildElectricityallocation $electricityallocation)
    {
        if ($this->getElectricityallocations()->contains($electricityallocation)) {
            ...
            $electricityallocation->setElectricityaccount(null);
        }
     ...
     * Otherwise if this Electricityaccount is new, it will return
     * an empty collection; or if this Electricityaccount has previously
     * been saved, it will retrieve related Electricityallocations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Electricityaccount.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildElectricityallocation[] List of ChildElectricityallocation objects
     */
    public function getElectricityallocationsJoinLineofbusiness(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildElectricityallocationQuery::create(null, $criteria);
    ...
    public function setElectricityexpenses(Collection $electricityexpenses, ConnectionInterface $con = null)
    {
        ...
        foreach ($electricityexpensesToDelete as $electricityexpenseRemoved) {
            $electricityexpenseRemoved->setElectricityaccount(null);
        }
    ...
    protected function doAddElectricityexpense(ChildElectricityexpense $electricityexpense)
    {
        ...
        $electricityexpense->setElectricityaccount($this);
    }
    ...
    public function removeElectricityexpense(ChildElectricityexpense $electricityexpense)
    {
        if ($this->getElectricityexpenses()->contains($electricityexpense)) {
            ...
            $electricityexpense->setElectricityaccount(null);
        }
     ...
     * @return ObjectCollection|ChildElectricityexpense[] List of ChildElectricityexpense objects
     */
    public function getElectricityexpensesJoinOpsmonthlycalendar(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildElectricityexpenseQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ElectricityaccountTableMap::DEFAULT_STRING_FORMAT);
    }
