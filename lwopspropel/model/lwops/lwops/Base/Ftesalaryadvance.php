...
/**
 * Base class that represents a row from the 'ftesalaryadvance' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Ftesalaryadvance implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\FtesalaryadvanceTableMap';
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Ftesalaryadvance object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Ftesalaryadvance</code> instance.  If
     * <code>obj</code> is an instance of <code>Ftesalaryadvance</code>, delegates to
     * <code>equals(Ftesalaryadvance)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Ftesalaryadvance The current object, for fluid interface
     */
     ...
     * @return $this|\lwops\lwops\Ftesalaryadvance The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[FtesalaryadvanceTableMap::COL_OID] = true;
        }
    ...
    public function setEmployeeoid($v)
    {
        ...
        if ($this->employeeoid !== $v) {
            $this->employeeoid = $v;
            $this->modifiedColumns[FtesalaryadvanceTableMap::COL_EMPLOYEEOID] = true;
        }
    ...
    public function setOpsmonthlycalendaroid($v)
    {
        ...
        if ($this->opsmonthlycalendaroid !== $v) {
            ...
            $this->modifiedColumns[FtesalaryadvanceTableMap::COL_OPSMONTHLYCALENDAROID] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[FtesalaryadvanceTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setPaid($v)
    {
        ...
        if ($this->paid !== $v) {
            $this->paid = $v;
            $this->modifiedColumns[FtesalaryadvanceTableMap::COL_PAID] = true;
        }
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[FtesalaryadvanceTableMap::COL_CREATETMSTP] = true;
            }
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[FtesalaryadvanceTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FtesalaryadvanceTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FtesalaryadvanceTableMap::translateFieldName('Employeeoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employeeoid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FtesalaryadvanceTableMap::translateFieldName('Opsmonthlycalendaroid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->opsmonthlycalendaroid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FtesalaryadvanceTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FtesalaryadvanceTableMap::translateFieldName('Paid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->paid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FtesalaryadvanceTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FtesalaryadvanceTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = FtesalaryadvanceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Ftesalaryadvance'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFtesalaryadvanceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Ftesalaryadvance::setDeleted()
     * @see Ftesalaryadvance::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFtesalaryadvanceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FtesalaryadvanceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[FtesalaryadvanceTableMap::COL_OID] = true;
        if (null !== $this->oid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . FtesalaryadvanceTableMap::COL_OID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_EMPLOYEEOID)) {
            $modifiedColumns[':p' . $index++]  = 'employeeOid';
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_OPSMONTHLYCALENDAROID)) {
            $modifiedColumns[':p' . $index++]  = 'opsMonthlyCalendarOid';
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'amount';
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_PAID)) {
            $modifiedColumns[':p' . $index++]  = 'paid';
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO ftesalaryadvance (%s) VALUES (%s)',
    ...
    {
        $pos = FtesalaryadvanceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Ftesalaryadvance'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Ftesalaryadvance'][$this->hashCode()] = true;
        $keys = FtesalaryadvanceTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Ftesalaryadvance
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Ftesalaryadvance The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(FtesalaryadvanceTableMap::DATABASE_NAME);

        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_OID)) {
            $criteria->add(FtesalaryadvanceTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_EMPLOYEEOID)) {
            $criteria->add(FtesalaryadvanceTableMap::COL_EMPLOYEEOID, $this->employeeoid);
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_OPSMONTHLYCALENDAROID)) {
            $criteria->add(FtesalaryadvanceTableMap::COL_OPSMONTHLYCALENDAROID, $this->opsmonthlycalendaroid);
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_AMOUNT)) {
            $criteria->add(FtesalaryadvanceTableMap::COL_AMOUNT, $this->amount);
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_PAID)) {
            $criteria->add(FtesalaryadvanceTableMap::COL_PAID, $this->paid);
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_CREATETMSTP)) {
            $criteria->add(FtesalaryadvanceTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(FtesalaryadvanceTableMap::COL_UPDTTMSTP)) {
            $criteria->add(FtesalaryadvanceTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildFtesalaryadvanceQuery::create();
        $criteria->add(FtesalaryadvanceTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Ftesalaryadvance (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Ftesalaryadvance Clone of current object.
     * @throws PropelException
     */
    ...
    public function getEmployee(ConnectionInterface $con = null)
    {
        if ($this->aEmployee === null && ($this->employeeoid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmployee->addFtesalaryadvances($this);
             */
        }
    ...
    public function getOpsmonthlycalendar(ConnectionInterface $con = null)
    {
        if ($this->aOpsmonthlycalendar === null && ($this->opsmonthlycalendaroid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOpsmonthlycalendar->addFtesalaryadvances($this);
             */
        }
    ...
    {
        if (null !== $this->aEmployee) {
            $this->aEmployee->removeFtesalaryadvance($this);
        }
        if (null !== $this->aOpsmonthlycalendar) {
            $this->aOpsmonthlycalendar->removeFtesalaryadvance($this);
        }
        $this->oid = null;
    ...
    {
        return (string) $this->exportTo(FtesalaryadvanceTableMap::DEFAULT_STRING_FORMAT);
    }
