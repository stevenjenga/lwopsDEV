...
/**
 * Base class that represents a row from the 'employeeterminationtype' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Employeeterminationtype implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\EmployeeterminationtypeTableMap';
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Employeeterminationtype object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Employeeterminationtype</code> instance.  If
     * <code>obj</code> is an instance of <code>Employeeterminationtype</code>, delegates to
     * <code>equals(Employeeterminationtype)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Employeeterminationtype The current object, for fluid interface
     */
     ...
     * @return $this|\lwops\lwops\Employeeterminationtype The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[EmployeeterminationtypeTableMap::COL_OID] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[EmployeeterminationtypeTableMap::COL_TYPE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[EmployeeterminationtypeTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EmployeeterminationtypeTableMap::COL_CREATETMSTP] = true;
            }
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EmployeeterminationtypeTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EmployeeterminationtypeTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EmployeeterminationtypeTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EmployeeterminationtypeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EmployeeterminationtypeTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EmployeeterminationtypeTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = EmployeeterminationtypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Employeeterminationtype'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEmployeeterminationtypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Employeeterminationtype::setDeleted()
     * @see Employeeterminationtype::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEmployeeterminationtypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EmployeeterminationtypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[EmployeeterminationtypeTableMap::COL_OID] = true;
        if (null !== $this->oid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . EmployeeterminationtypeTableMap::COL_OID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO employeeterminationtype (%s) VALUES (%s)',
    ...
    {
        $pos = EmployeeterminationtypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Employeeterminationtype'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Employeeterminationtype'][$this->hashCode()] = true;
        $keys = EmployeeterminationtypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
            $keys[1] => $this->getType(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Employeeterminationtype
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Employeeterminationtype The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(EmployeeterminationtypeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_OID)) {
            $criteria->add(EmployeeterminationtypeTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_TYPE)) {
            $criteria->add(EmployeeterminationtypeTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_DESCRIPTION)) {
            $criteria->add(EmployeeterminationtypeTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_CREATETMSTP)) {
            $criteria->add(EmployeeterminationtypeTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(EmployeeterminationtypeTableMap::COL_UPDTTMSTP)) {
            $criteria->add(EmployeeterminationtypeTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildEmployeeterminationtypeQuery::create();
        $criteria->add(EmployeeterminationtypeTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Employeeterminationtype (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Employeeterminationtype Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildEmployeeterminationtype is new, it will return
        ...
        if (null === $this->collEmployeeterminations || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collEmployeeterminations) {
                ...
                $collEmployeeterminations = ChildEmployeeterminationQuery::create(null, $criteria)
                    ->filterByEmployeeterminationtype($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEmployeeterminationtype The current object (for fluent API support)
     */
    public function setEmployeeterminations(Collection $employeeterminations, ConnectionInterface $con = null)
    {
        ...
        foreach ($employeeterminationsToDelete as $employeeterminationRemoved) {
            $employeeterminationRemoved->setEmployeeterminationtype(null);
        }
    ...
    protected function doAddEmployeetermination(ChildEmployeetermination $employeetermination)
    {
        ...
        $employeetermination->setEmployeeterminationtype($this);
    }
    ...
    public function removeEmployeetermination(ChildEmployeetermination $employeetermination)
    {
        if ($this->getEmployeeterminations()->contains($employeetermination)) {
            ...
            $employeetermination->setEmployeeterminationtype(null);
        }
     ...
     * Otherwise if this Employeeterminationtype is new, it will return
     * an empty collection; or if this Employeeterminationtype has previously
     * been saved, it will retrieve related Employeeterminations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Employeeterminationtype.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildEmployeetermination[] List of ChildEmployeetermination objects
     */
    public function getEmployeeterminationsJoinEmployee(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildEmployeeterminationQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(EmployeeterminationtypeTableMap::DEFAULT_STRING_FORMAT);
    }
