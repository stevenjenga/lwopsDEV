...
/**
 * Base class that represents a row from the 'elecdeductionrate' table.
 *
 *
 *
 * @package    propel.generator.lwops.lwops.Base
 */
abstract class Elecdeductionrate implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\lwops\\lwops\\Map\\ElecdeductionrateTableMap';
    ...
    /**
     * Initializes internal state of lwops\lwops\Base\Elecdeductionrate object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Elecdeductionrate</code> instance.  If
     * <code>obj</code> is an instance of <code>Elecdeductionrate</code>, delegates to
     * <code>equals(Elecdeductionrate)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Elecdeductionrate The current object, for fluid interface
     */
     ...
     * @return $this|\lwops\lwops\Elecdeductionrate The current object (for fluent API support)
     */
    public function setOid($v)
    {
        ...
        if ($this->oid !== $v) {
            $this->oid = $v;
            $this->modifiedColumns[ElecdeductionrateTableMap::COL_OID] = true;
        }
    ...
    public function setRate($v)
    {
        ...
        if ($this->rate !== $v) {
            $this->rate = $v;
            $this->modifiedColumns[ElecdeductionrateTableMap::COL_RATE] = true;
        }
    ...
    public function setStartdt($v)
    {
        ...
        if ($this->startdt !== null || $dt !== null) {
            if ($this->startdt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->startdt->format("Y-m-d H:i:s.u")) {
                $this->startdt = $dt === null ? null : clone $dt;
                $this->modifiedColumns[ElecdeductionrateTableMap::COL_STARTDT] = true;
            }
    ...
    public function setEnddt($v)
    {
        ...
        if ($this->enddt !== null || $dt !== null) {
            if ($this->enddt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->enddt->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ElecdeductionrateTableMap::COL_ENDDT] = true;
            }
        } // if either are not null
    ...
    public function setCreatetmstp($v)
    {
        ...
        if ($this->createtmstp !== null || $dt !== null) {
            if ($this->createtmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createtmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ElecdeductionrateTableMap::COL_CREATETMSTP] = true;
            }
        } // if either are not null
    ...
    public function setUpdttmstp($v)
    {
        ...
        if ($this->updttmstp !== null || $dt !== null) {
            if ($this->updttmstp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updttmstp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ElecdeductionrateTableMap::COL_UPDTTMSTP] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ElecdeductionrateTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ElecdeductionrateTableMap::translateFieldName('Rate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rate = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ElecdeductionrateTableMap::translateFieldName('Startdt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->startdt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ElecdeductionrateTableMap::translateFieldName('Enddt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->enddt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ElecdeductionrateTableMap::translateFieldName('Createtmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createtmstp = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ElecdeductionrateTableMap::translateFieldName('Updttmstp', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = ElecdeductionrateTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\lwops\\lwops\\Elecdeductionrate'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildElecdeductionrateQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Elecdeductionrate::setDeleted()
     * @see Elecdeductionrate::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildElecdeductionrateQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ElecdeductionrateTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_RATE)) {
            $modifiedColumns[':p' . $index++]  = 'rate';
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_STARTDT)) {
            $modifiedColumns[':p' . $index++]  = 'startDt';
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_ENDDT)) {
            $modifiedColumns[':p' . $index++]  = 'endDt';
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_CREATETMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'createTmstp';
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_UPDTTMSTP)) {
            $modifiedColumns[':p' . $index++]  = 'updtTmstp';
        }

        $sql = sprintf(
            'INSERT INTO elecdeductionrate (%s) VALUES (%s)',
    ...
    {
        $pos = ElecdeductionrateTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Elecdeductionrate'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Elecdeductionrate'][$this->hashCode()] = true;
        $keys = ElecdeductionrateTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOid(),
            $keys[1] => $this->getRate(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\lwops\lwops\Elecdeductionrate
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\lwops\lwops\Elecdeductionrate The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_OID)) {
            $criteria->add(ElecdeductionrateTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_RATE)) {
            $criteria->add(ElecdeductionrateTableMap::COL_RATE, $this->rate);
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_STARTDT)) {
            $criteria->add(ElecdeductionrateTableMap::COL_STARTDT, $this->startdt);
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_ENDDT)) {
            $criteria->add(ElecdeductionrateTableMap::COL_ENDDT, $this->enddt);
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_CREATETMSTP)) {
            $criteria->add(ElecdeductionrateTableMap::COL_CREATETMSTP, $this->createtmstp);
        }
        if ($this->isColumnModified(ElecdeductionrateTableMap::COL_UPDTTMSTP)) {
            $criteria->add(ElecdeductionrateTableMap::COL_UPDTTMSTP, $this->updttmstp);
        }
    ...
    {
        $criteria = ChildElecdeductionrateQuery::create();
        $criteria->add(ElecdeductionrateTableMap::COL_OID, $this->oid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \lwops\lwops\Elecdeductionrate (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \lwops\lwops\Elecdeductionrate Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ElecdeductionrateTableMap::DEFAULT_STRING_FORMAT);
    }
